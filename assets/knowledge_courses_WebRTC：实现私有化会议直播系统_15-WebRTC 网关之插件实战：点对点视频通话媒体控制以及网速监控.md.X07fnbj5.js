...
<span class="line"><span>});</span></span></code></pre></div><p><strong>演示</strong></p><p><img src="`+d+`" alt="" loading="lazy"></p><h2 id="流量速率监控" tabindex="-1">流量速率监控 <a class="header-anchor" href="#流量速率监控" aria-label="Permalink to &quot;流量速率监控&quot;">​</a></h2><p>在视频通话过程中，媒体流量的监控不仅仅可以将会话过程中的<strong>媒体传输信息</strong>以最直观的方式给用户展示出来，同时也可以利用监控到的传输速率优化通话质量，用户端可以直接动态调整媒体发送的速率。</p><p>流量实时监控也离不开我们一直提到的句柄（pluginHandle），具体监控代码如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>getBitrate(){</span></span>
