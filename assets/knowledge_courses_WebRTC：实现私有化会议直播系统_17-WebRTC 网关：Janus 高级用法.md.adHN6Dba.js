...
<span class="line"><span>                }</span></span>
<span class="line"><span>        });</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><img src="`+t+'" alt="img" loading="lazy"></p><p>看上图日志，mid:0 为音频流，mid:1 为视频流，mid:3 也是视频流（我分享屏幕的流），也就是说，我在摄像头语音的同时，屏幕分享也是同步分发的。</p><p>请注意监听到的流不一定都是添加哦，<code>added</code>为 true 的是有新的流过来，false 则表示某个流断开或者该用户离开了。</p><p><img src="'+c+`" alt="img" loading="lazy"></p><h2 id="音频级别会话提醒" tabindex="-1">音频级别会话提醒 <a class="header-anchor" href="#音频级别会话提醒" aria-label="Permalink to &quot;音频级别会话提醒&quot;">​</a></h2><p>这个功能算是会议中最友好的功能了，尤其是在 N 多个人开会的时候，会自动显示是哪位参会人在讲话，具体设置还是和 videoRoom 插件相关的。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>let create = {</span></span>
<span class="line"><span>    request : &#39;create&#39;,</span></span>
<span class="line"><span>    room: parseInt(roomId),</span></span>
<span class="line"><span>    bitrate: bitrate ? parseInt(bitrate)*1000: 300*1000,</span></span>
<span class="line"><span>    publishers: roomUserCount? parseInt(roomUserCount) : 12,//参与人数</span></span>
