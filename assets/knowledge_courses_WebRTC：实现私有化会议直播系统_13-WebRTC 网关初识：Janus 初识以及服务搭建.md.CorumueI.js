...
<span class="line"><span>## 后面我们还会遇到各种插件同样的下载方法 最核心的就是上面俩个</span></span></code></pre></div><ol start="3"><li>docker-compose 文件创建以及路径挂载。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>cd /home/janus-docker &amp;&amp; touch docker-compose.yml</span></span>
...
<span class="line"><span>    restart: always</span></span></code></pre></div><ol start="4"><li>修改基础配置。</li></ol><blockquote><p><code>janus.jcfg</code> 中找下面条目配置修改，一定要注意找到对应的位置哦。</p><p><code>api_secret</code> 为我们后面常用的重点配置，Rest API 的通行证。</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>##新版本中下面这几个路径在配置文件中是@@变量赋值，这里大家可以直接写成下面的</span></span>
...
<span class="line"><span>}</span></span>
<span class="line"><span>-----------------</span></span>
<span class="line"><span>## 当然还有其他的配置 比如stun 、turn、nat_1_1_mapping等这里先不用管</span></span></code></pre></div><blockquote><p><code>janus.transport.http.jcfg</code> 配置</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>general: {                                                </span></span>
...
<span class="line"><span>        https = false           #https是否启用配置；启用的话后面就要配置ssl证书。</span></span></code></pre></div><ol start="5"><li>启动。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>cd /home/janus-docker </span></span>
