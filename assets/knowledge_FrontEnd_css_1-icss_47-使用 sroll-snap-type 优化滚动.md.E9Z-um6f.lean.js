...
`,-1),u=i("",17),C=s("iframe",{height:"300",style:{width:"100%"},scrolling:"no",title:"CSS Scroll Snap Points Full Height",src:"https://codepen.io/mafqla/embed/NWJdGqM?default-tab=html%2Cresult&editable=true&theme-id=light",frameborder:"no",loading:"lazy",allowtransparency:"true",allowfullscreen:"true"},`
  ...
  on <a href="https://codepen.io">CodePen</a>.
`,-1),b=s("p",null,"当然，兼容性现在还是很大的问题：",-1),S=s("p",null,[a("不过在很多场景下，就算 "),s("code",null,"scroll-snap-"),a(" 相关几个属性暂不兼容，也不会对正常使用造成影响，所以在很多场景，这些属性都可以直接应用上去，对支持的浏览器提供更好的交互。")],-1),E=[B,g,F,y,D,m,A,_,f,u,C,b,S];function q(x,v,P,T,w,N){return e(),n("div",null,E)}const I=l(c,[["render",q]]);export{V as __pageData,I as default};
