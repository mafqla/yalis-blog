...
<span class="line"><span>                </span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>},</span></span></code></pre></div><ol start="4"><li>操作①：点击对方画面框框（Video DOM 元素），然后观察控制台和右下角画面显示。</li></ol><ol start="5"><li>操作②：点击自己的视频（右下角显示画面），观察控制台。</li></ol><p><img src="`+l+'" alt="" loading="lazy"></p><ol start="6"><li>参数变更说明：上图红色圈圈中的就是设置前的参数，后面绿色的就是变更后的参数，大家可以发现，这个和我代码中的一致。请注意：我在代码中并没有设置分辨率的 <code>width</code>，但是它也变了，为何？答案就在本节前面参数详解第四条中：当你设置固定的宽高之后<code>aspectRatio</code>会自动变更，相反，仅设置<code>aspectRatio</code>参数后，其他 <code>height</code> 和 <code>width</code> 参数也会变动。</li></ol><h2 id="代码仓库" tabindex="-1">代码仓库 <a class="header-anchor" href="#代码仓库" aria-label="Permalink to &quot;代码仓库&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/demo03-many2many.vue" target="_blank" rel="noreferrer">本节课代码位置</a></p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><ol><li>请大家根据这节课学到的内容，去改造下点对点视频通话过程中媒体流的变更。</li><li>完成第一个问题后，可以尝试摄像头和屏幕分享流的切换，即和对方分享自己的桌面。</li></ol>',60),i=[c];function d(r,h,g,k,m,u){return n(),a("div",null,i)}const _=s(o,[["render",d]]);export{v as __pageData,_ as default};
