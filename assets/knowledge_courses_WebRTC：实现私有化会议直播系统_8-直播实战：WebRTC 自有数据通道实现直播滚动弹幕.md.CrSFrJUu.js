...
<span class="line"><span>          };</span></span>
<span class="line"><span>        };</span></span></code></pre></div><p><img src="`+p+`" alt="" loading="lazy"></p><ol start="3"><li>发送消息。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//datasechannel 为创建通道端初始化后的通道实例</span></span>
