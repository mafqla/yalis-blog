...
<span class="line"><span>Hit CTRL-C to stop the server</span></span></code></pre></div><p><img src="`+l+'" alt="" loading="lazy"></p><p>看上面项目截图，<code>红色框框标记的位置：模型文件和被代理后的模型文件地址</code>。如果大家要在线上使用该虚拟背景，那么这个静态文件是必须要有的，官网的例子使用的是 CDN 链接，但是该 CDN 在网络已被限制，因此这里给大家演示<code>离线的版本</code>。</p><ol start="3"><li>选择摄像头和麦克风参数后点击确定。等待模型加载完毕后视频的旁边 Canvas幕布中就是实时显示虚拟背景画面。</li></ol><p><img src="'+i+'" alt="" loading="lazy"></p><h2 id="完整代码地址" tabindex="-1">完整代码地址 <a class="header-anchor" href="#完整代码地址" aria-label="Permalink to &quot;完整代码地址&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/virtualbg.vue" target="_blank" rel="noreferrer">本节课相关代码</a></p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><p>这节课的内容，如果你已经完全消化，那么我们实现虚拟背景的目的就很好达到了。但是完成后，如何将这个虚拟背景转化为媒体流，并发送给对直播间的观众呢？欢迎大家在留言区讨论。</p>',50),c=[o];function r(d,m,g,h,v,u){return n(),a("div",null,c)}const k=s(t,[["render",r]]);export{f as __pageData,k as default};
