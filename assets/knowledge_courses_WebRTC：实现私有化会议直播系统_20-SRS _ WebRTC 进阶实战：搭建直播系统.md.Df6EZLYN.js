...
<span class="line"><span>}</span></span></code></pre></div><ol start="2"><li>主播同意。同意后直接先根据观众发的流拉流即可。</li></ol><p><img src="`+l+`" alt="" loading="lazy"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>if(e[&#39;type&#39;] === &#39;applyMic&#39;){</span></span>
...
<span class="line"><span>http://localhost:8082/srs-rtc-push?userId=999&amp;roomId=111</span></span></code></pre></div><ol start="2"><li>点击推流，右上角则会直接用 RTC 去拉流预览，成功则自动会在直播预览那里显示画面，否则会弹出失败提示框。</li></ol><p><img src="`+o+'" alt="" loading="lazy"></p><ol start="3"><li>点击麦克风或者摄像头切换，以及屏幕分享可以查看右上角预览画面变更（注意默认右上角画面是静音的，请手动开启）。</li><li>访问直播间模块页面，携带参数为推流页面的流 ID。</li></ol><p><img src="'+d+`" alt="" loading="lazy"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//携带个人信息+直播间流ID+tid(主播ID)</span></span>
<span class="line"><span>http://localhost:8082/srs-live-room?liveroomid=localStream-1673368291508&amp;tid=999&amp;userId=1010&amp;roomId=111</span></span></code></pre></div><ol start="5"><li>点击页面右侧“申请连麦”，观察推流模块画面以及当前页面控制台。</li></ol><p><img src="`+r+'" alt="" loading="lazy"></p><h2 id="本节相关源码" tabindex="-1">本节相关源码 <a class="header-anchor" href="#本节相关源码" aria-label="Permalink to &quot;本节相关源码&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/srs-rtc-push.vue" target="_blank" rel="noreferrer">相关源码地址</a></p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><p>在申请连麦那里我做了简化，直接自动同意连麦人员画面，在实际过程中肯定是不行的，请大家优化这个步骤，比如实现主播同意、拒绝的弹窗提醒等。</p>',57),m=[u];function g(v,b,k,y,R,_){return n(),a("div",null,m)}const T=s(h,[["render",g]]);export{S as __pageData,T as default};
