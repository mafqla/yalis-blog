...
<span class="line"><span>let total = biterate * 4 = 3.24 Mb/s</span></span></code></pre></div><p>上面的计算结果和在线的比特率计算器我们可以对比下：<a href="https://www.omnicalculator.com/other/streaming-bitrate" target="_blank" rel="noreferrer">在线比特率计算器</a></p><p><img src="`+t+`" alt="" loading="lazy"></p><p>总的算下来四个视频发出去需要消耗的上行宽带至少是 每秒 <strong>4M</strong> 左右，如果再加上你需要获取别的人员的视频，就需要单独的下行宽带也在 每秒 <strong>4M</strong> 左右，一般而言上行宽带和下行宽带是不等价的，从前面测试中就可以发现。</p><h2 id="优化会议质量" tabindex="-1">优化会议质量 <a class="header-anchor" href="#优化会议质量" aria-label="Permalink to &quot;优化会议质量&quot;">​</a></h2><p>了解了消耗宽带的计算，我们就需要优化我们的会议系统了，在<strong>小册第二讲</strong>中我们我们讲到了很多约束参数，根据实际情况我们再看下参数，实际情况帧速率 24 就可以了，所以我们设置 FPS 为 24，但是在网络状况差的时候是可以接受延缓的，因此如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>const constraints = {</span></span>
