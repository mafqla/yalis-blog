...
<span class="line"><span>  })</span></span></code></pre></div><p><img src="`+i+`" alt="" loading="lazy"></p><p>上面除了基础的用户信息，还携带了一些其他的参数，记录当前用户使用的是哪个摄像头或者麦克风，这些不是必需的，因此可以去掉。</p><h3 id="新用户入会" tabindex="-1">新用户入会 <a class="header-anchor" href="#新用户入会" aria-label="Permalink to &quot;新用户入会&quot;">​</a></h3><p><strong>对于入会者</strong></p><p>新用户加入到会议室后，还要发布自己的媒体流到 <code>MCU</code> 服务器，也就是 <code>SRS</code> 中，这样其他用户就可以通过新用户的 ID 从 <code>SRS</code> 中拉取媒体流。</p><p>入会后必须判断房间内是否已经有参会人员，如果有，则拉取已参会人员的媒体流。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//监听房间用户列表 （新用户加入房间后首先会发送房间列表回调事件，等拿到用户列表后再开始初始化会议室）</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>},</span></span></code></pre></div><p><strong>对于已在会议室用户</strong></p><p>新人入会，已经在会议中的人员是会收到事件通知的。如下，用户 ID 为 999 的新人加入会议室后，其他成员看到的信息。</p><p><img src="`+t+`" alt="" loading="lazy"></p><p>此时，已在会议室的成员监听到加入事件后，必须主动拉取新人画面，如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>if(e[&#39;type&#39;] === &#39;join&#39;){</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h3 id="用户离开会议室" tabindex="-1">用户离开会议室 <a class="header-anchor" href="#用户离开会议室" aria-label="Permalink to &quot;用户离开会议室&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//通知房间内成员</span></span>
