...
<span class="line"><span>}</span></span></code></pre></div><p>客户端携带加入房间的基础信息，有基础用户信息和 pub 这个身份信息，服务端接受这个参数后，将其保存在房间缓存信息中：</p><p><img src="`+o+`" alt="" loading="lazy"></p><p><strong>老师 T</strong> <strong>端</strong>作为发布者，在加入房间后就需要发布自己的直播流，此时还没有任何学生和他建立连接。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//?userId=9999&amp;roomId=10013&amp;nickname=S&amp;pub=pub</span></span>
