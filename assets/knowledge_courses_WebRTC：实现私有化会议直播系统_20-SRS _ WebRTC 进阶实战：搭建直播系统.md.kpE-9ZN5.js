...
<span class="line"><span>http://localhost:8082/srs-live-room?liveroomid=localStream-1673368291508&amp;tid=999&amp;userId=1010&amp;roomId=111</span></span></code></pre></div><ol start="5"><li>点击页面右侧“申请连麦”，观察推流模块画面以及当前页面控制台。</li></ol><p><img src="`+r+'" alt="" loading="lazy"></p><h2 id="本节相关源码" tabindex="-1">本节相关源码 <a class="header-anchor" href="#本节相关源码" aria-label="Permalink to &quot;本节相关源码&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/srs-rtc-push.vue" target="_blank" rel="noreferrer">相关源码地址</a></p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><p>在申请连麦那里我做了简化，直接自动同意连麦人员画面，在实际过程中肯定是不行的，请大家优化这个步骤，比如实现主播同意、拒绝的弹窗提醒等。</p>',57),u=[m];function g(v,b,k,_,y,R){return n(),a("div",null,u)}const f=s(h,[["render",g]]);export{q as __pageData,f as default};
