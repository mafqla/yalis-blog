...
<span class="line"><span>}</span></span></code></pre></div><ul><li>A 接受 B 的 <code>answer</code>信令后，将其设置为 <code>remoteDesc </code>。</li></ul><p><img src="`+p+`" alt="" loading="lazy"></p><blockquote><p><strong>注意看日志中的<code>candidate</code>，这个过程是贯穿整个会话的，直到<code>ice</code>候选完成。</strong></p></blockquote><p><strong>被呼叫端<code>B</code>。</strong></p><blockquote><p>被呼叫端的过程和呼叫端类似，大体代码如下：</p></blockquote><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>async initCalleeInfo(localUid,fromUid){</span></span>
<span class="line"><span>        //初始化pc</span></span>
<span class="line"><span>        this.localRtcPc = new PeerConnection()</span></span>
