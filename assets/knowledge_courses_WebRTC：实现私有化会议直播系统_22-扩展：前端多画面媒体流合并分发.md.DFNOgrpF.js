import{_ as s,c as a,o as n,a5 as e}from"./chunks/framework.u52bZU8k.js";const p="/assets/1.eTtXRlql.image",l="/assets/2.B_ocyECp.image",t="/assets/3.C0_FqjXL.image",i="/assets/4.CqaUUNwJ.image",k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"knowledge/courses/WebRTC：实现私有化会议直播系统/22-扩展：前端多画面媒体流合并分发.md","filePath":"knowledge/courses/WebRTC：实现私有化会议直播系统/22-扩展：前端多画面媒体流合并分发.md","lastUpdated":1716967418000}'),c={name:"knowledge/courses/WebRTC：实现私有化会议直播系统/22-扩展：前端多画面媒体流合并分发.md"},r=e(`<p>上节课，我们提到了在<code>MCU</code>服务器处理音视频的过程中，可能会涉及到合并媒体流，实际上，这个合并媒体流的“任务”，在客户端我们也可以借助某些巧妙设计做到的，比如<code>Canvas</code>将两个媒体流通过“错位的”的方式贴合在一起，最终呈现出一个画面，但是画面是合成画面。</p><p>接下来，我们利用现成的开源组件库去实现这个目标。</p><h2 id="组件基本应用" tabindex="-1">组件基本应用 <a class="header-anchor" href="#组件基本应用" aria-label="Permalink to &quot;组件基本应用&quot;">​</a></h2><p>组件地址：<a href="https://github.com/t-mullen/video-stream-merger" target="_blank" rel="noreferrer">Github</a>。</p><p>演示地址：<a href="https://t-mullen.github.io/video-stream-merger/" target="_blank" rel="noreferrer">Demo</a>。</p><p>首先安装组件依赖：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>cnpm install video-stream-merger -S</span></span></code></pre></div><p><strong>实战</strong></p><p>比如将一个 MP4 视频和摄像头的画面合成。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code" tabindex="0"><code><span class="line"><span>//组件引入</span></span>
