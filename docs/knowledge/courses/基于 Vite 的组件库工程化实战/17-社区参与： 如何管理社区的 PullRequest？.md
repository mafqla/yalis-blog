...
![img](images\b8b347d7246f48b0a5fd46de28c1c54a~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\3ec9d0b7d2d84b0c908796d0757bfdbd~tplv-k3u1fbpfcp-zoom-1.jpg)

![img](images\e6fe717f6fe944c5a54ad728ba994969~tplv-k3u1fbpfcp-zoom-1.jpg)

点击 【Create fork】就可以了。

![img](images\534ee08b08f1441cb9fc266f4020ceab~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\38e226d02c364c16b4546f732e885a70~tplv-k3u1fbpfcp-zoom-1.jpg)

![img](images\5e412fb9bc8d448f9f0645b9e4f6f455~tplv-k3u1fbpfcp-zoom-1.jpg)

```Bash
git commit -am 'fix: del Button.tsx useless comments'
```

![img](images\d734542d4784467da54b6b3ec49fa864~tplv-k3u1fbpfcp-zoom-1.jpg)

```Bash
git push
```

![img](images\6fdde31852ae4602935172207dd17a08~tplv-k3u1fbpfcp-zoom-1.jpg)

提交代码后，回到 su37josephxia/smarty-admin 的 Github 页面。这个时候就可以看到这个提交。这是一个新的功能，可以更方便你提交 PullRequest。

![img](images\dd945f7a115c4853ad4e0b3a2d24c5e6~tplv-k3u1fbpfcp-zoom-1.jpg)

点击 【Contribute】中的 【Open pull request】按钮，就可以创建一个新的 PullRequest 了。

![img](images\ab7216fe70994c18b1d1e73a77b17bfb~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\87e379d4456c4a1fb86fd219b33e443a~tplv-k3u1fbpfcp-zoom-1.jpg)

另外，你也可以从后面的比对中清楚地看到你修改的内容。

![img](images\7f0f4755f47042b9b12207f47eaa9ebc~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\ca764601103e4236aefcfc5cc8c22e9e~tplv-k3u1fbpfcp-zoom-1.jpg)

打开后可以查阅代码变更，也可以清楚地看到这个代码 CI 运行的结果。通过这个结果就可以判断代码是否正确，也可以提出一定的改进意见，让你继续进行修改。

![img](images\49727e60836642ed91128262b6b8da2a~tplv-k3u1fbpfcp-zoom-1.jpg)

![img](images\46341df93d7b48c98e9beba2f0b8c213~tplv-k3u1fbpfcp-zoom-1.jpg)

假设认为你的修改是有价值的，就可以批准你的修改。点击 Merge pull request 就可以接受这次代码合并。这时，你的代码也就合并到了 smarty-team/ smarty-admin 仓库中了，这次代码贡献宣告胜利结束。

![img](images\5820525266734daabd722b0d81c65699~tplv-k3u1fbpfcp-zoom-1.jpg)

![img](images\6fd12526652f4ba2be0153702a0c4f50~tplv-k3u1fbpfcp-zoom-1.jpg)
