...
![img](images\c002eb89adf24cfbafdbf56f88baa82c~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\1f7622da5a5d4c359a80122622e15bd8~tplv-k3u1fbpfcp-zoom-1.jpg)

解决的办法就是在 vite.config.ts 中增加一个类型定义声明

![img](images\faa418d172df45b7a4d2111f5a2fc281~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\6a3a4d1847394b089680a65f801ec554~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\461a9488b98b4433bbedfe4b750cd3c4~tplv-k3u1fbpfcp-zoom-1.jpg)

上面的测试只是测试了按钮的默认状态。对于按钮组件来讲，它的主要逻辑是根据不同的 props 属性来定制不同的样式。下面我们针对这些逻辑继续编写测试。

![img](images\54b28a93f8504e26aaa4ee8dcc254035~tplv-k3u1fbpfcp-zoom-1.jpg)
