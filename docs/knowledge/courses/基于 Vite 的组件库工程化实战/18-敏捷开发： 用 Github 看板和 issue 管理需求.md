...
![img](images\c9838825c5794219a9e9fb084fa9302e~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\5a681b121342490c842d7db4195d85f6~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\648a84e2f92a435e8b39251bc0b7e687~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\3e03b0a8dc7e4b3cac4be78537ab32a4~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\6986aaa5350044d98e7d6788c4cabff8~tplv-k3u1fbpfcp-zoom-1.jpg)

首先，开启一个项目 【Smarty UI Vite Alpha.1】 开发。接下来可以选择一下项目的种类。

视图方式可以选择 Table 和 Board，Board 就是看板模式。这个模式其实就和大多数敏捷团队中使用的实体看板是一样的。

![img](images\c23b7c6faa85472486c81f2612597173~tplv-k3u1fbpfcp-zoom-1.jpg)

然后回到 smarty-admin 中将 Project 挂载到此仓库。

![img](images\ec8281f90758411a8c312fcc439a8a47~tplv-k3u1fbpfcp-zoom-1.jpg)
...
![img](images\98ab94d8416d48eca4e6974aa051de69~tplv-k3u1fbpfcp-zoom-1.jpg)

![img](images\3e231de99f5141cb9a99fbb5426ba76f~tplv-k3u1fbpfcp-zoom-1.jpg)

1. 分配项目

接着就是评估 ISSUE 的重要度和复杂度，来确定开发的有限顺序。

![img](images\bade5701b141457aac1d2357d978f9ba~tplv-k3u1fbpfcp-zoom-1.jpg)

跟着就需要分配任务到开发者，或者开发者自觉认领。其实开源团队这个过程一般都是认领的比较多。

![img](images\bf153fba4d1f4ab69c7163f6d6f1b09c~tplv-k3u1fbpfcp-zoom-1.jpg)

接下来就是使用，看板功能跟踪项目过程。这个过程比较直观，就不赘述了。 

![img](images\183b0bf5bf9f44779e3a5f536f8c941f~tplv-k3u1fbpfcp-zoom-1.jpg)
