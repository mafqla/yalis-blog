...
![image.png](images\c4388a793e3b4e3089671f3cb3c98fc6~tplv-k3u1fbpfcp-watermark.jpg)

但如果你是通过 Electron 的 BrowserWindow 创建的浏览器窗口，去打印 `process`，就能显示内容

![image.png](images\a07f1d7f604c4bb8a5926d5fcc8b0a80~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\e4dfc584f5a342c39ab81428547674b5~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\504ff257b452423b8def126f04c019bf~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\33a60ac35ff7405aa1147d07f688179d~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\378e37f1831f4c248a3a61993229c6b0~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\2513e45145d64e9fafef265a1b1fe4e2~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\7e0e62b706d6418581f1534389395b61~tplv-k3u1fbpfcp-watermark.jpg)

进入到 package 目录下，找到 mac 目录，进入可以看到一个可执行文件

双击打开，发现好像有些问题

![image.png](images\a097e1846c534f329ed7711232130d2c~tplv-k3u1fbpfcp-watermark.jpg)

![image.png](images\82054e21a00b4115a8be69d63938b577~tplv-k3u1fbpfcp-watermark.jpg)

#### 💥 What？问题很多

- 怎么主题配色的功能消失了？换言之，读取的 `appConfig` 文件好像都不存在？正因为读不到，所以没有了主题列表

![image.png](images\e65867f3db9b4a7eaff03a06ddcda6a4~tplv-k3u1fbpfcp-watermark.jpg)

- 点击进入`简历制作` 模块无反应？

![image.png](images\d03a738a300143e084d35f17e78126db~tplv-k3u1fbpfcp-watermark.jpg)

- 模版列表怎么都没图片了，我们从 `assets/template` 文件夹中读取的模版封面，怎么也不见了呢？

![image.png](images\5a9f5742976d4a7abdb69a46c9fb80f3~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\ad62e9bed9fa477e9d308585d23012bf~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\02d0e3bbfd13445894ead26c2ed9db52~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\096eba1318a542b1b3e99f197aa24ba4~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\8ce2d9eaf0f341a8b8a99c3110329a20~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\605cc0bdb2a94ab79b3b8274afdbb35a~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\da1b0e509f26497e8c5931ea88af8c3f~tplv-k3u1fbpfcp-watermark.jpg)

然后我们刷新一下页面，我们鼠标悬浮到 `appPath` 上，看看输出的是什么

![image.png](images\3259c6216b544cbfbc3a7de3e2d61cf4~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\8167132a54294a338f6da47c64b5e628~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\8c68120ea49a4b179d315fa88b79adae~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\36ba7b5b46174cb086e35379b100e7fb~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\684c8ed1977c4f379a45677cbd3be34a~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\964f90e578e04f49b6b738a2df495815~tplv-k3u1fbpfcp-watermark.jpg)

让我们看看 `package` 下有什么文件

![image.png](images\721a127bd49b41baa042befc8a5f0eb6~tplv-k3u1fbpfcp-watermark.jpg)

有一个 `zip` 和 `dmg`，我是 Mac 电脑，所以我双击打开 dmg 的安装包进行安装

![image.png](images\22f4e6753c694edf8b6c9709a83ea1c7~tplv-k3u1fbpfcp-watermark.jpg)

安装之后就能愉快使用啦

![image.png](images\718e0634e9f0463ca3a5e57459735ac8~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\7d60079195cc40ab93a7f6337d8abc0d~tplv-k3u1fbpfcp-watermark.jpg)
