...
![image.png](images\093bee154a5144099f4151bc2e0de53c~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\288d42df432e4d8ea719d025377cd36d~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\c0ba367c61234a74acb6c7d326a7d51a~tplv-k3u1fbpfcp-watermark.jpg)

## 应用设置模块代码实现

通过上边实践，我们完成了“应用设置”窗口的创建，接下来我们来实现一下具体功能。先看一下原型稿

![image.png](images\2666b219bfbb4d5ca19246d50c16a1b8~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\c5de2a1e20844de99923261eae3622e9~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\8573b9c8ba8b49269a050e72b818ffa3~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\d8fcfd628bf54db6bd2ab4b4078c5c74~tplv-k3u1fbpfcp-watermark.jpg)

在修改更改存储路径上，也是通过读写操作全局配置表文件进行实现。

![image.png](images\25d4456fe720427499d20e57e1c24f18~tplv-k3u1fbpfcp-watermark.jpg)

在主应用窗口中，导出 PDF 时，读取文件内容，得到存储地址。这里需要注意：**如果用户压根就没打开应用设置窗口，进行存储路径的配置，那么需要给定一个默认地址。**

![image.png](images\8638639ca99e4cafa01af65a0f0b7ca5~tplv-k3u1fbpfcp-watermark.jpg)
...
![image.png](images\6f07e0f49def4556809784f74528431d~tplv-k3u1fbpfcp-watermark.jpg)
