...
<span class="line"><span>                }</span></span>
<span class="line"><span>        });</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><img${ssrRenderAttr("src", _imports_4)} alt="img" loading="lazy"></p><p>看上图日志，mid:0 为音频流，mid:1 为视频流，mid:3 也是视频流（我分享屏幕的流），也就是说，我在摄像头语音的同时，屏幕分享也是同步分发的。</p><p>请注意监听到的流不一定都是添加哦，<code>added</code>为 true 的是有新的流过来，false 则表示某个流断开或者该用户离开了。</p><p><img${ssrRenderAttr("src", _imports_5)} alt="img" loading="lazy"></p><h2 id="音频级别会话提醒" tabindex="-1">音频级别会话提醒 <a class="header-anchor" href="#音频级别会话提醒" aria-label="Permalink to &quot;音频级别会话提醒&quot;">​</a></h2><p>这个功能算是会议中最友好的功能了，尤其是在 N 多个人开会的时候，会自动显示是哪位参会人在讲话，具体设置还是和 videoRoom 插件相关的。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>let create = {</span></span>
<span class="line"><span>    request : &#39;create&#39;,</span></span>
<span class="line"><span>    room: parseInt(roomId),</span></span>
<span class="line"><span>    bitrate: bitrate ? parseInt(bitrate)*1000: 300*1000,</span></span>
<span class="line"><span>    publishers: roomUserCount? parseInt(roomUserCount) : 12,//参与人数</span></span>
...
<span class="line"><span>          }</span></span>
<span class="line"><span>        })</span></span>
<span class="line"><span>},</span></span></code></pre></div><p>核心参数也就那么几个，在代码中我都注释了，很好理解。</p><p>具体演示：</p><p><img${ssrRenderAttr("src", _imports_7)} alt="image.png" loading="lazy"></p><h2 id="本节课相关代码" tabindex="-1">本节课相关代码 <a class="header-anchor" href="#本节课相关代码" aria-label="Permalink to &quot;本节课相关代码&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/demo04-janus-02.vue" target="_blank" rel="noreferrer">本接口代码仓库地址</a></p><h2 id="小结" tabindex="-1">小结 <a class="header-anchor" href="#小结" aria-label="Permalink to &quot;小结&quot;">​</a></h2><p>通过 videoCall 和 videoRoom 插件，我们实现了会议所需要的基本功能，无论是控制还是展示，Janus 网关可以很轻易地实现一个无需后台的私有化会议室，这对于我们业务而言是最佳的。</p><p>所以如果你的业务场景中需要会议系统，但不想自己实现信令服务器，则完全可以用现在的第二种架构来实现。</p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><p>既然都学习了两种插件的用法了，那么大家课后可以玩玩另一个插件：<code>janus.plugin.streaming</code>，这个插件可以实现各种媒体流的播放，比如：RTP、RTSP、RTMP 等。对流媒体有使用场景的同学，我相信很需要这个插件，如果遇到问题了，可以在评论区或社群留言。</p></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("knowledge/courses/WebRTC：实现私有化会议直播系统/17-WebRTC 网关：Janus 高级用法.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _17WebRTC____Janus_____ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  _17WebRTC____Janus_____ as default
};
