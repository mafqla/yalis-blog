...
<span class="line"><span>        })</span></span>
<span class="line"><span>},</span></span></code></pre></div><ol start="3"><li><p>C 用户进入会议室：初始化服务连接，获取房间用户，同时本地媒体流获取和预览。但房间中有 A 和 B，因此和 B 步骤一样。</p><ol><li>C 和 A 创建 <code>RTC 关联</code>。</li><li>C 和 B 创建 <code>RTC 关联</code>。</li></ol></li></ol><p><strong>根据</strong> <strong>上面的步骤</strong> <strong>，</strong> <strong>我们就可以还原如下流程了</strong> <strong>。</strong> <strong>在整个房间人员变动中，无论如何</strong> <strong>，</strong> <strong>新进来的用户都会去和房间内的其他人进行</strong> <strong>RTC</strong> <strong>关联</strong> <strong>，</strong> <strong>并实现新用户媒体流广播，从而达到我们这节课的目的：Mesh 架构的会议系统。</strong></p><p><img${ssrRenderAttr("src", _imports_4)} alt="" loading="lazy"></p><h2 id="项目操作指南" tabindex="-1">项目操作指南 <a class="header-anchor" href="#项目操作指南" aria-label="Permalink to &quot;项目操作指南&quot;">​</a></h2><ol><li>打开项目，找到模块：多对多网络视频。</li></ol><p><img${ssrRenderAttr("src", _imports_5)} alt="" loading="lazy"></p><ol start="2"><li>点击进去后首先会显示填写基础信息，要体验会议那么要加入的用户必须在同一个房间；此外，请大家注意下面图中的<code>身份ID</code>，它默认获取的是当前浏览器的指纹，因此如果在同一个浏览器不同标签页访问页面当前页面时<code>身份ID</code>都是一样的。<strong>为了避免这个问题请大家注意我访问的时候携带的参数，这个参数优先于浏览器指纹且手动指定</strong>，这样就可以避免不同用户<code>身份ID</code>一样造成加入会议失败的情况。</li></ol><p><img${ssrRenderAttr("src", _imports_6)} alt="" loading="lazy"></p><ol start="3"><li>用不同的身份ID，但是<code>同一个房间号</code>进入会议室。</li></ol><h2 id="完整代码地址" tabindex="-1">完整代码地址 <a class="header-anchor" href="#完整代码地址" aria-label="Permalink to &quot;完整代码地址&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/demo03-many2many.vue" target="_blank" rel="noreferrer">本节课相关代码仓库地址</a></p><h2 id="课后题" tabindex="-1">课后题 <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;课后题&quot;">​</a></h2><p>在本地启动成功并模拟会议成功后，请大家尝试部署到<code>区域网</code>的某个主机上，然后通过区域网进行多人会议看看效果如何，有问题大家留言一起讨论。</p></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("knowledge/courses/WebRTC：实现私有化会议直播系统/9-会议实战：WebRTC 实现多房间多用户的第一种架构会议系统.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _9______WebRTC___________________ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  _9______WebRTC___________________ as default
};
