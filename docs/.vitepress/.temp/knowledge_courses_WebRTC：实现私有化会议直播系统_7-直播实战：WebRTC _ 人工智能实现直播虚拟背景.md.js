...
<span class="line"><span>    })</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><strong>演示</strong></p><p><img${ssrRenderAttr("src", _imports_1)} alt="" loading="lazy"></p><h2 id="项目操作指南" tabindex="-1">项目操作指南 <a class="header-anchor" href="#项目操作指南" aria-label="Permalink to &quot;项目操作指南&quot;">​</a></h2><ol><li>打开项目，找到模块：小型直播。</li></ol><ol start="2"><li>流程第五节的流程一样。第五节中，如果大家已经运行过源码，那么应该已看到主播端中间一栏 写有 <code>直播开始后点击背景即可切换直播背景</code>的醒目提示。当时给大家说不用理会，但是现在是时候试试了。</li></ol><ol start="3"><li>在观众和主播都已经就位后，此时还不是点击背景开始虚拟背景的时机，请问你的模型文件夹内的模型被代理了吗？代码中是否已配置模型加载路径？如果没有请回到上一节重新再复习一边。</li></ol><ol start="4"><li>模型文件没问题后此刻就可以点击中间的虚拟背景了，任选一个然后稍等几秒钟就可以在两端看到效果。</li></ol><p><img${ssrRenderAttr("src", _imports_2)} alt="" loading="lazy"></p><h2 id="完整代码地址" tabindex="-1"><strong>完整代码地址</strong> <a class="header-anchor" href="#完整代码地址" aria-label="Permalink to &quot;**完整代码地址**&quot;">​</a></h2><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/blob/main/webrtc-link-demo/src/views/demo03-one2many.vue" target="_blank" rel="noreferrer">直播部分代码</a></p><p><a href="https://github.com/wangsrGit119/suke-webrtc-course/tree/main/virtualbg-model" target="_blank" rel="noreferrer">虚拟背景源码</a></p><h2 id="课后作业" tabindex="-1"><strong>课后作业</strong> <a class="header-anchor" href="#课后作业" aria-label="Permalink to &quot;**课后作业**&quot;">​</a></h2><p>在直播使用虚拟背景的时候，大家可以注意下不同浏览器的 <code>FPS</code>，比如 360、谷歌、edge 等，然后开启浏览器的硬件加速后，再测试下 <code>FPS</code> 看下有何不同，同时注意计算机的资源占用情况。</p></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("knowledge/courses/WebRTC：实现私有化会议直播系统/7-直播实战：WebRTC + 人工智能实现直播虚拟背景.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _7______WebRTC_______________ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  _7______WebRTC_______________ as default
};
