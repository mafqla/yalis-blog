...
<span class="line"><span>          };</span></span>
<span class="line"><span>        };</span></span></code></pre></div><p><img${ssrRenderAttr("src", _imports_0)} alt="" loading="lazy"></p><ol start="3"><li>发送消息。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>//datasechannel 为创建通道端初始化后的通道实例</span></span>
...
<span class="line"><span>http://localhost:8080/demo03-one2many?userId=22222&amp;roomId=10012&amp;nickname=US02</span></span></code></pre></div><ol start="4"><li>操作：主播端在页面下方输入框输入消息，然后点击发送，注意观察 <code>US01</code> 和 <code>US02</code> 两端的<code>控制台</code>以及<code>弹幕</code>显示。</li></ol><ol start="5"><li>效果。</li></ol><p><img${ssrRenderAttr("src", _imports_1)} alt="" loading="lazy"></p><p><strong>温馨提示</strong></p><p>弹幕我是利用组件展示在 <code>Video 元素</code>之上，大家实际用的时候可能会自定义其他的展示窗体，因此你需要明白的是数据通道数据过来的代码位置，在这里你可以<code>自定义数据操作逻辑</code>。</p><p><img${ssrRenderAttr("src", _imports_2)} alt="" loading="lazy"></p><h2 id="课后题" tabindex="-1"><strong>课后题</strong> <a class="header-anchor" href="#课后题" aria-label="Permalink to &quot;**课后题**&quot;">​</a></h2><p>这节课算是把<code>WebRTC</code>的数据通道掌握了，实际上数据通道不仅仅可以实现弹幕，利用这个，还可以实现很多花样，课后大家可以再熟悉熟悉数据通道用法，<strong>传输文件、图片</strong> 等数据。</p></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("knowledge/courses/WebRTC：实现私有化会议直播系统/8-直播实战：WebRTC 自有数据通道实现直播滚动弹幕.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _8______WebRTC_______________ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  _8______WebRTC_______________ as default
};
