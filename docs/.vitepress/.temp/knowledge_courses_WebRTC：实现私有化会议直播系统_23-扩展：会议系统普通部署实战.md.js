...
<span class="line"><span>axios.post(this.$srsServerAPIURL+&#39;rtc/v1/publish/&#39;,data)</span></span></code></pre></div><p>上面配置的地址，如果你线上使用的<code>HTTPS</code>协议，那么项目内部<code>API</code>请求也需要配置<code>HTTPS</code>，同样可通过<code>nginx</code>代理。</p><h3 id="服务器端口配置" tabindex="-1">服务器端口配置 <a class="header-anchor" href="#服务器端口配置" aria-label="Permalink to &quot;服务器端口配置&quot;">​</a></h3><p>我们在会话过程中会遇到很多端口，部署到线上阿里云、腾讯云等云厂商服务器后，需要去安全组开放特定的端口，这样外部才能进行访问。这里我将常见的需要大家注意的端口着重说明下：</p><ul><li>信令服务器端口：项目中默认配置的<code>18080</code>，大家可以自定义，然后在安全组放行。</li></ul><p><img${ssrRenderAttr("src", _imports_0)} alt="" loading="lazy"></p><ul><li>WebRTC 网关 Janus 服务 API 端口，示例中为<code>18088</code>，安全组需要放行。</li></ul><p><img${ssrRenderAttr("src", _imports_1)} alt="" loading="lazy"></p><ul><li>Janus 网关 RTP 数据交换端口。</li></ul><p><img${ssrRenderAttr("src", _imports_2)} alt="" loading="lazy"></p><ul><li><code>coturn</code>服务端口，看下图红色框框中的端口配置。</li></ul><p><img${ssrRenderAttr("src", _imports_3)} alt="" loading="lazy"></p><h2 id="实战部署" tabindex="-1">实战部署 <a class="header-anchor" href="#实战部署" aria-label="Permalink to &quot;实战部署&quot;">​</a></h2><ol><li>前端项目打包。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>npm run build</span></span></code></pre></div><ol start="2"><li>打包好的<code>dist</code>文件夹放到和信令服务同目录。</li></ol><p><img${ssrRenderAttr("src", _imports_4)} alt="" loading="lazy"></p><ol start="3"><li>启动信令服务。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>&gt; node app.js</span></span>
<span class="line"><span>服务器启动成功 *:18080</span></span>
<span class="line"><span>redis 连接成功</span></span></code></pre></div><ol start="4"><li>浏览器输入信令服务 IP+端口。</li></ol><p><img${ssrRenderAttr("src", _imports_5)} alt="" loading="lazy"></p><ol start="5"><li><code>Nginx</code>代理并绑定域名，注意域名配置成自己的，下面示例为我的线上域名。</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>server {</span></span>
