...
<span class="line"><span>            }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>        }</span></span></code></pre></div><h3 id="项目演示指南" tabindex="-1">项目演示指南 <a class="header-anchor" href="#项目演示指南" aria-label="Permalink to &quot;项目演示指南&quot;">​</a></h3><p>下载代码后，找到目录下： socket-server 文件夹，到文件夹执行依赖安装并配置 Redis 链接。 <img${ssrRenderAttr("src", _imports_4)} alt="" loading="lazy"></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>   cd socket-server</span></span>
