...
const _imports_0 = "/assets/1.qhslougl.image";
const _imports_1 = "/assets/2.k1-2kxwk.image";
const _imports_2 = "/assets/3.K2ZMH1Rf.image";
const _imports_3 = "/assets/4.J4-KaTwW.image";
const _imports_4 = "/assets/5.r7wo_HKl.image";
const _imports_5 = "/assets/6.F5yRVtNd.image";
const _imports_6 = "/assets/7.YavuxJNH.image";
const _imports_7 = "/assets/8.4xbPZ9WY.image";
const __pageData = JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"knowledge/courses/WebRTC：实现私有化会议直播系统/15-WebRTC 网关之插件实战：点对点视频通话媒体控制以及网速监控.md","filePath":"knowledge/courses/WebRTC：实现私有化会议直播系统/15-WebRTC 网关之插件实战：点对点视频通话媒体控制以及网速监控.md","lastUpdated":1704161604000}');
const _sfc_main = { name: "knowledge/courses/WebRTC：实现私有化会议直播系统/15-WebRTC 网关之插件实战：点对点视频通话媒体控制以及网速监控.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><p>上节课我们学习了Janus 插件相关的一些基础知识，接下来我们将进行 <code>VideoCall</code>插件的实战，以及用它实现三个比较重要且常用的功能：点对点的视频通话、媒体控制、网速监控。</p><h2 id="点对点视频通话" tabindex="-1">点对点视频通话 <a class="header-anchor" href="#点对点视频通话" aria-label="Permalink to &quot;点对点视频通话&quot;">​</a></h2><p>视频通话的步骤和我们生活中遇到的一样，都是先呼叫，然后等对方应答，对方同意之后我们再继续推送自己的视频流等信息。这些步骤在前面的第一种架构中，我们都是通过自己的 Socket 信令服务器完成对应事件的。但是，现在我们有了 Janus 网关服务之后，这些所有的事件通知，网关都会替我们完成转发，而我们只需要关注页面上对应步骤中的展示逻辑即可。</p><p>我们继续看看 Janus 是如何替我们完成这些操作的。</p><h3 id="网关中注册用户信息" tabindex="-1"><strong>网关中注册用户信息</strong> <a class="header-anchor" href="#网关中注册用户信息" aria-label="Permalink to &quot;**网关中注册用户信息**&quot;">​</a></h3><p>通话的前提是你要知道对方在当前系统的用户名，同时别人也要能在系统中找到你，因此在呼叫开始之前，我们要做的就是注册我们自己的标识信息到当前 <strong>Janus 网关中</strong>。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>registerUser(){</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><img${ssrRenderAttr("src", _imports_6)} alt="" loading="lazy"></p><h2 id="媒体控制" tabindex="-1">媒体控制 <a class="header-anchor" href="#媒体控制" aria-label="Permalink to &quot;媒体控制&quot;">​</a></h2><p>这是本节课的第二个话题，所谓媒体控制就是对我们发送出去的媒体做出变更、暂停、恢复等操作。</p><p>上一节我们在通过客户端 SDK 初始化插件时提到过一个叫做句柄的东西（pluginHandle），实际上在使用 Janus 的网关的过程中，所有的主动或者被动性操作都是可以通过它来实现，媒体控制也是一样的。</p><p>在具体操作之前，我们先看官方 API：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>{</span></span>
...
<span class="line"><span>});</span></span></code></pre></div><p><strong>演示</strong></p><p><img${ssrRenderAttr("src", _imports_7)} alt="" loading="lazy"></p><h2 id="流量速率监控" tabindex="-1">流量速率监控 <a class="header-anchor" href="#流量速率监控" aria-label="Permalink to &quot;流量速率监控&quot;">​</a></h2><p>在视频通话过程中，媒体流量的监控不仅仅可以将会话过程中的<strong>媒体传输信息</strong>以最直观的方式给用户展示出来，同时也可以利用监控到的传输速率优化通话质量，用户端可以直接动态调整媒体发送的速率。</p><p>流量实时监控也离不开我们一直提到的句柄（pluginHandle），具体监控代码如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes one-dark-pro material-theme-palenight vp-code"><code><span class="line"><span>getBitrate(){</span></span>
