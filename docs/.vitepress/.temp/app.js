...
var Copyright_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span></div>`);
      if (unref(isOriginal)) {
        _push(`<div class="item" data-v-85dc38a9><svg class="icon" viewBox="0 0 1024 1024" data-v-85dc38a9><title data-v-85dc38a9>作品协议</title><path d="M0 512a512 512 0 1 0 1024 0A512 512 0 1 0 0 512z" fill="#F3B243" data-v-85dc38a9></path><path d="M540.672 323.584a90.112 90.112 0 1 0 180.224 0 90.112 90.112 0 1 0-180.224 0zM540.672 688.128a90.112 90.112 0 1 0 180.224 0 90.112 90.112 0 1 0-180.224 0zM229.376 512a90.112 90.112 0 1 0 180.224 0 90.112 90.112 0 1 0-180.224 0z" fill="#FFF" data-v-85dc38a9></path><path d="M341.037 480.37l257.344-175.718 27.713 40.592-257.34 175.718z" fill="#FFF" data-v-85dc38a9></path><path d="M349.053 488.452L601.907 670.56l-28.725 39.887L320.307 528.34z" fill="#FFF" data-v-85dc38a9></path></svg><span data-v-85dc38a9>作品采用：</span><span data-v-85dc38a9>《<a${ssrRenderAttr("href", unref(theme2).copyrightConfig.licenseLink)} target="_blank" data-v-85dc38a9>${ssrInterpolate(unref(theme2).copyrightConfig.license)}</a>》许可协议授权</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
