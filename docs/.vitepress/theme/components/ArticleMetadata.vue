<template>
  <div class="meta-wrapper">
    ...
    <div
      class="meta-item"
      v-if="showCategory && Object.keys(categories).length !== 0"
    >
    ...
    <div class="meta-item tag" v-if="Object.keys(tags).length !== 0">
...
const data = reactive({
  ...
  viewCount: 0,
  date: props.article?.date.string || props.article?.date,
