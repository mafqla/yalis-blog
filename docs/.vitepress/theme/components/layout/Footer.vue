<template>
  <footer class="VPFooter">
    <div class="container">
      <p
        v-if="theme.footerConfig.message"
        class="copyright"
        v-html="theme.footerConfig.message"
      ></p>
      <p v-if="theme.footerConfig.icpRecordCode" class="recordCode">
        ...
        <span class="content">
          <a href="https://beian.miit.gov.cn" target="_blank">{{
            theme.footerConfig.icpRecordCode
          }}</a>
        </span>
      </p>
      ...
      <p
        v-if="theme.footerConfig.copyright"
        class="copyright"
        v-html="theme.footerConfig.copyright"
      ></p>
    </div>
  </footer>
</template>
